// Python 3.14 Execution Environment Acceptance
//
// Verifies the published python-3.14 execution environment honours its
// execution contract:
...
test("Python 3.14 execution environment acceptance", async ({ page }) => {
